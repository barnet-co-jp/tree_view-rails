...
const focusedMockupSmokeTargets = [
  ...
  { file: "large-tree-strategy/index.html", sample: ".mock-large-tree-card", minimumCount: 5 },
  ...
  { file: "graph-adapter-heterogeneous-nodes/index.html", sample: "[data-tree-node-key]", minimumCount: 4 },
...
const narrowOverflowExpectedMockups = new Map([
  ...
  ["large-tree-strategy/index.html", { category: "inspectable-columns", reason: "large-tree strategy comparison keeps ownership and strategy table columns inspectable" }],
  ...
  ["graph-adapter-heterogeneous-nodes/index.html", { category: "inspectable-columns", reason: "heterogeneous node comparison keeps type, metadata, status, and action columns inspectable" }],
