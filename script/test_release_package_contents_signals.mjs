...
const packageContentsVerificationSignals = [
  [
    ...
    [
      ...
      "../AGENTS.md",
      "Forbidden repository-only root doc links in packaged #{path}",
  ...
  [
    ...
    [
      ...
      "`homepage_uri`, `source_code_uri`, `documentation_uri`, `changelog_uri`, and `bug_tracker_uri`",
      "`required_ruby_version`, `allowed_push_host`, and runtime dependency `railties >= 7.0`",
      "repository-only `Product Profile.md` or `AGENTS.md`",
      "`../Product%20Profile.md` or `../AGENTS.md`",
      "Forbidden repository-only root doc links in packaged <path>",
  ...
  [
    ...
    [
      ...
      "`homepage_uri`、`source_code_uri`、`documentation_uri`、`changelog_uri`、`bug_tracker_uri`",
      "`required_ruby_version`、`allowed_push_host`、runtime dependency `railties >= 7.0`",
      "repository-only の `Product Profile.md` や `AGENTS.md`",
      "`../Product%20Profile.md` や `../AGENTS.md`",
      "Forbidden repository-only root doc links in packaged <path>",
